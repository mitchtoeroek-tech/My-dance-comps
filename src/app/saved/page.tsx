...
export default function SavedPage() {
  const { toggleFavourite, isFavourite, toggleEnrolled, isEnrolled, state } =
    useFamily();
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        synced. Star a comp to include it in registration reminders. Confirmed
        entries live on My Comps, and friends see those enrolments when you are
        signed in.
      </p>
      {comps.length === 0 ? (
        <EmptyState
